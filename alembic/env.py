...
# Import the SQLAlchemy metadata object from your application
...
database_url = os.environ.get("DATABASE_URL", "postgresql://postgres:postgres@localhost:5432/social_suit")
